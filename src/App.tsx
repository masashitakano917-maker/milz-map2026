                ...
                <AnimatePresence>
                  {isFiltering && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -10 }}
                      className="bg-white/95 backdrop-blur-md shadow-2xl border border-stone-200 p-5 md:p-8 space-y-6 md:space-y-8 rounded-[2rem] md:rounded-[2.5rem] max-h-[calc(100svh-20rem)] md:max-h-[calc(100svh-14rem)] overflow-y-auto mb-32 md:mb-10"
                    >
